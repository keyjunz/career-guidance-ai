STATUS_MESSAGES = {
    ...
    "question_stored": "Question saved to user store.",
    ...
    "evaluator_running": "Evaluating answer quality.",
    "fixer_running": "Refining answer based on evaluation.",
    "answer_stored": "Answer saved to user store.",
